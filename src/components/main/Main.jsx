...
<div className='d-flex gen'>
  <div className='gen-child'><h1 className='text-white'>The Next</h1> <h1 className='text-gradient'>Generation</h1></div>
...
<div className='d-flex ps-1 py-2 pe-2 align-items-center rewards firstr'>
  ...
  <div className='d-flex text-white flex-column'>
    <h2>Rewards</h2>
    <p className='pa'>The best credit cards offer some tantalizing combinations of promotions and prizes</p>
  </div>
</div>
<div className='d-flex ps-1 py-2 pe-2 align-items-center rewards text-white firstr'>
  <div><img src='assets/Group481744.png' alt='' className='ps-0 pb-1 pe-2'/></div>
  <div className='d-flex flex-column'> 
    <h2>100% Secured</h2>
    <p className=' pa'>We take proactive steps make sure your information and transactions are secure.</p>
  </div>
</div>
<div className='d-flex ps-1 py-2 pe-2 text-white rewards align-items-center firstr'>
  <div><img src='assets/Group481745.png' alt='' className='ps-0 pb-1 pe-2'/></div>
  <div className='d-flex flex-column'>
...
<div className=' firstr d-flex flex-column ps-lg-5'> 
  ...
  <p className='text-white fs-5 p pb-4'>Elit enim sed massa etiam MAuris euadipscing ultrices ametodio aenanen anenwue. Fuse ipsum orci rhoncus aliporttiot integer platea placerat</p>
<div className='d-flex flex-row mt-2' >
<img src='assets/Group481724.png' alt='' className='me-3'/>
<img src='assets/Group481725.png' alt='' />
</div>
  </div>
</section>
